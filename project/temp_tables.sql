...
SELECT o.operation_id, a.account_id, c.client_id, CONCAT(c.first_name, ' ', c.last_name) client_name, o.amount, o.occurred_at
FROM operations o 
JOIN operation_types ot ON o.operation_type_id = ot.operation_type_id
JOIN accounts a ON o.account_id = a.account_id
JOIN clients c ON a.client_id = c.client_id
WHERE ot.operation_name = 'Deposit' AND o.occurred_at >= NOW() - INTERVAL '1 month' AND a.currency_code = 'RUB'
